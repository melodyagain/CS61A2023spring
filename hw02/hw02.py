...
# def func2(stop):
#     # 暂时未定义stop
#     # ⭐为什么⭐start⭐传参传不过来！！！！！气死我了！！！！
#     i=start
#     if i >= stop:
#         return func1(i)
#     totle = 1
#     while func1(i) <= func2(stop):
#         totle = totle*func1(i)
#         # ⭐这里⭐start是一个值！
#         i += 1
#     return totle
# #  错误理解： func2不能在funception下，否则，在全局中就调不出来了
# # 为什么fun2要定义在内部，而不能放在外面
...
# TypeError: unsupported operand type(s) for *: 'function' and 'int'⭐错误：不能直接用mul_by_num乘
